...
namespace FilmesApi.Services
{
    public class EnderecoService
    {
        ...
        public ReadEnderecoDto AdicionaEndereco(CreateEnderecoDto enderecoDto)
        {
            ...
            return _mapper.Map<ReadEnderecoDto>(endereco);  //Converte para para exibir o resultado
        }

        public List<ReadEnderecoDto> RecuperaEnderecos()        //TESTAR TESTAR TESTAR TESTAR
        {
